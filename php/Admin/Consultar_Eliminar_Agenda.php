...
echo "<table>";
echo "<td><b>Id de la agenda</b></td><td><b>Nombre del paciente</b></td><td><b>Trabajador Asignado</b></td><td><b>Servicio</b></td><td><b>Fecha</b></td><td><b>Estado</b></td><td><b>Valor</b></td><td><b>Eliminar</b></td>";
while($fila =mysqli_fetch_array($result)){
	...
	echo $fila["Valor"];
	echo"</td>";
	echo"<td><a HREF=\"../../formularios/Eliminar_Agenda.php?id=$id\" id=\"$id\" name=\"$id\">Eliminar</a></td>";
